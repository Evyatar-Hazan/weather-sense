...
class TestInMemoryCacheBasic:
    def setup_method(self):
        ...
        self.test_data = {
            ...
            "longitude": 34.78,
            "daily": [
                {"date": "2025-10-20", "tmin": 20.0, "tmax": 28.0}
            ]
        }
    ...
    def test_generate_key_format(self):
        ...
        key = self.cache._generate_key(32.08, 34.78, "2025-10-20", "2025-10-24", "metric")
    ...
    def test_generate_key_precision(self):
        ...
        key = self.cache._generate_key(32.08456, 34.78123, "2025-10-20", "2025-10-24", "imperial")
        expected = "32.08,34.78,2025-10-20,2025-10-24,imperial"
        assert key == expected
    
    def test_generate_key_consistency(self):
        """Test cache key generation is consistent."""
        key1 = self.cache._generate_key(32.08, 34.78, "2025-10-20", "2025-10-24", "metric")
        key2 = self.cache._generate_key(32.08, 34.78, "2025-10-20", "2025-10-24", "metric")
        assert key1 == key2
...
class TestInMemoryCacheOperations:
    ...
    def test_set_and_get_data(self):
        ...
        # Set data
        self.cache.set(32.08, 34.78, "2025-10-20", "2025-10-24", "metric", self.test_data)
...
class TestInMemoryCacheClear:
    ...
    def test_clear_cache_with_data(self):
        ...
        self.cache.set(32.08, 34.78, "2025-10-20", "2025-10-24", "metric", self.test_data)
        self.cache.set(40.71, -74.01, "2025-10-20", "2025-10-24", "imperial", self.test_data)
    ...
    def test_clear_and_reuse_cache(self):
        ...
        new_result = self.cache.get(40.71, -74.01, "2025-10-20", "2025-10-24", "imperial")
...
class TestInMemoryCachePerformance:
    ...
    def test_multiple_entries_performance(self):
        ...
        for i in range(100):
            ...
            self.cache.set(
                float(i), float(i), 
                f"2025-10-{i%28+1:02d}", f"2025-10-{(i%28+1)+1:02d}", 
                "metric", data
            )
