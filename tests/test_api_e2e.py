...
class TestWeatherAPI:
    ...
    def test_weather_ask_missing_auth(self):
        ...
        response = self.client.post(
            "/v1/weather/ask", json={"query": "weather in Tel Aviv"}
        )
    ...
    def test_weather_ask_missing_query(self):
        ...
        response = self.client.post(
            "/v1/weather/ask", headers=self.valid_headers, json={}
        )
    ...
    def test_weather_ask_response_timing(self, mock_process_query):
        ...
        response = self.client.post(
            "/v1/weather/ask", headers=self.valid_headers, json={"query": "test query"}
        )
