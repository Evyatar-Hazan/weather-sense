...
class WeatherProvider:
    ...
    def fetch_weather_data(self, lat: float, lon: float, start_date: str, end_date: str, units: str) -> Dict[str, Any]:
        """
    ...
    def _safe_get(self, data_list: Optional[List], index: int, default: Any = None) -> Any:
