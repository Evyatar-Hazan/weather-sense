...
def get_logger_with_context(name: str, request_id: str = None, task: str = None) -> logging.Logger:
...
def log_request(logger: logging.Logger, request_id: str, task: str, duration_ms: int, status: str, message: str = "") -> None:
